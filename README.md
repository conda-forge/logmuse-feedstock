...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/logmuse-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8346&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/logmuse-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `logmuse` can be installed with:

```
conda install logmuse
```

It is possible to list all of the versions of `logmuse` available on your platform with:
